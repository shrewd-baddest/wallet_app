...
const getTransactionHistory = async (req, res) => {
    try {
        ...
        const wallet = await (0, knex_1.default)("wallets")
        ...
        let query = (0, knex_1.default)("transactions")
        ...
        const transactions = await query
            ...
            .select("id", "transaction_code", "type", "amount", "status", "description", "reference_id", "created_at");
        ...
        const totalIn = await (0, knex_1.default)("transactions")
            .where("wallet_id", wallet.id)
            .whereIn("type", [
            "deposit",
            "transfer_received",
            ...
            .sum("amount as total")
            .first();
        const totalOut = await (0, knex_1.default)("transactions")
            .where("wallet_id", wallet.id)
            .whereIn("type", [
            "withdrawal",
            "transfer_sent",
