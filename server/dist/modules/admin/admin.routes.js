...
router.patch('/users/:userId/wallet-status', [(0, express_validator_1.body)('status').isIn(['active', 'suspended']).withMessage('Status must be active or suspended')], validate_1.default, ctrl.setWalletStatus);
